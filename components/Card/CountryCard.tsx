...
import { getCountryNrOfRecordings, getNrOfRecordingsFromSubDialect } from "../../domain/application/application";
  ...
  return (
    <HLinearGradient colors={colors} start={{ x: 0, y: 1 }} end={{ x: 1, y: 0 }} styles={styles.container}>
      <View style={styles.bottomContainer}>
        ...
        <Text style={styles.cardSubTitle}>{getCountryNrOfRecordings(country.name)} voice recordings</Text>
        <Margin />
      </View>
    </HLinearGradient>
  );
